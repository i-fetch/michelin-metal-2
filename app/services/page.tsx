    ...
    <>
      ...
      <section className="relative pt-36 pb-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0" style={{ background:'linear-gradient(to right, rgba(9,9,11,0.90) 50%, rgba(9,9,11,0.50) 100%)' }} />
        </div>
        <div className="wrap px-5 relative z-10">
          <AOS>
            <p className="tag tag-gold mb-5">What We Do</p>
            <h1 className="text-white mb-5 leading-none" style={{ fontFamily:'var(--font-display)', fontSize:'clamp(3rem,7vw,5.5rem)' }}>
              OUR SERVICES
            </h1>
            <p className="text-white/60 max-w-xl text-lg" style={{ fontWeight:300 }}>
