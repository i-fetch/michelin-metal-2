...
import { ArrowRight, CheckCircle2, Mail, MapPin, MessageSquare, Phone, Send } from 'lucide-react'
  ...
  return (
    <>
      ...
      <section className="section" style={{ background:'var(--bg-2)' }}>
        <div className="wrap px-5">
          <AOS>
            <h3 className="text-center mb-6 text-2xl" style={{ fontFamily:'var(--font-display)', color:'var(--tx-primary)' }}>OUR LOCATION</h3>
            <div className="rounded-2xl overflow-hidden flex items-center justify-center"
              style={{ height:280, border:'1.5px solid var(--border)', background:'var(--bg-3)' }}>
              <div className="text-center p-8">
                <MapPin size={44} style={{ color:'var(--clr-green)', margin:'0 auto 1rem' }} />
                <p className="font-bold mb-1" style={{ color:'var(--tx-primary)', fontFamily:'var(--font-display)', fontSize:'1.2rem' }}>
                  No. 23 Nathan Okafor Street
                </p>
                <p className="text-sm mb-5" style={{ color:'var(--tx-muted)' }}>Awada Obosi, Anambra State, Nigeria</p>
                <a href="https://maps.google.com/?q=Awada+Obosi+Anambra+Nigeria"
                  target="_blank" rel="noopener noreferrer"
                  className="btn btn-green text-sm" style={{ padding:'0.6rem 1.4rem' }}>
