...
import {
  ...
  ExternalLink, Settings, BarChart3, Layers,
} from 'lucide-react'
    ...
    <aside className="admin-sidebar">
      ...
      <div className="px-5 py-5" style={{ borderBottom: '1px solid var(--border)' }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold leading-none" style={{
            ...
            <p className="text-[10px] mt-0.5" style={{ color: 'var(--tx-faint)' }}>Admin Console</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 p-3 space-y-1">
        <p className="text-[9px] font-bold uppercase tracking-widest px-3 py-2 mt-1"
        ...
        <p className="text-[9px] font-bold uppercase tracking-widest px-3 py-2 mt-4"
          style={{ color: 'var(--tx-faint)' }}>
          Site
        </p>
        <Link
      ...
      <div className="p-3" style={{ borderTop: '1px solid var(--border)' }}>
        ...
        <form action={logoutAction}>
          <button type="submit"
            ...
            onMouseLeave={e => { e.currentTarget.style.color = 'var(--tx-faint)'; e.currentTarget.style.background = 'transparent' }}
          >
