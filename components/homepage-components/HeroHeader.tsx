...
import { ArrowRight, CheckCircle, Globe2, MedalIcon, Package, Recycle, ShieldCheck, TrendingUp, Truck, Zap } from 'lucide-react'
...
export default function HeroHeader() {
   return (
      <>
         ...
         {/* ── ABOUT STRIP ──────────────────────────────────── */}
         <section className="hidden section" style={{ background: 'var(--bg)' }}>
         ...
         {/* ── PILLARS ───────────────────────────────────────── */}
         <section className="hidden section" style={{ background: 'var(--bg-2)' }}>
            <div className="wrap px-1">
               <div>
