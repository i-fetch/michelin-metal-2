  ...
  return (
    <footer style={{ background:'var(--bg-2)', borderTop:'1px solid var(--border)' }}>
      ...
      <div style={{ borderTop:'1px solid var(--border)', padding:'1rem 0' }}>
        <div className="wrap px-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs" style={{ color:'var(--tx-faint)' }}>
          <span>© {new Date().getFullYear()} Mechelin Metals Nigeria PVT LTD. All rights reserved.</span>
          <span>Metal Recycle Industry · West Africa</span>
        </div>
      </div>
    </footer>
  )
