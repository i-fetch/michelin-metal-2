...
export default function LocationsSection() {
    ...
    return (
        <section className="section py-20" style={{ background: 'var(--bg-2)' }}>
            <div className="wrap max-w-6xl mx-auto px-5">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3 text-sm pb-4" style={{ borderBottom: '1px solid var(--border)' }}>
                                            ...
                                            <div className="flex justify-between gap-4 text-xs" style={{ color: 'var(--tx-muted)' }}>
